	...
	if($stmt->rowCount() == 1) {		
		if(isset($_POST['btn-reset-pass'])) {			
			...
			if($cpass!==$pass) {				
				...
				header("refresh:5;login_form5.php");			
			}		
		}		
	}	
	else {		
		$msg = "<div class='alert alert-success'><button class='close' data-dismiss='alert'>&times;</button> No account found, try again.</div>";					
	}		
}
...
<body id="login">
<div class="container">
  <div class='alert alert-success'> <strong>Hello !</strong> <?php echo $rows['userName'] ?> you are here to reset your forgetton password. </div>
