...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] == false) {
    header("Location: failedstakeout.htm"); # user goes to locked version if they aren't logged in
}
...
if (isset($_POST['submit']))
	...
	if (is_numeric($_POST['id']))
		...
		if ($caseNum == '' || $startDate == '')
			...
			mysql_query("UPDATE cases SET caseNum='$caseNum', caseName='$caseName',startDate='$startDate', endDate='$endDate' WHERE id='$id'")
			or die(mysql_error()); 
