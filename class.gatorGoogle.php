...
class USER {
	...
	function send_mail($email,$message,$subject) {
		...
		$mail->SMTPAuth   = true;
		$mail->SMTPSecure = "ssl";
		$mail->Host       = "smtp.vivaldi.net";
		$mail->Port       = 465;
		$mail->AddAddress($email);
		$mail->Username="stakeout@vivaldi.net";
		$mail->Password="We2CanFly!";
		$mail->SetFrom('stakeout@vivaldi.net','Stakeout Registration');
		$mail->AddReplyTo("stakeout@vivaldi.net","Stakeout Registration");
